...
class MultiAgentEnv():
    ...
    def __init__(self, world, reset_callback=None, reward_callback=None,
                 ...
                 done_callback=None, rx_callback=None, full_state_callback=None):
        ...
        self.full_state_callback = full_state_callback
    ...
    def step(self, action_n):
        ...
        return obs_n, np.asarray(reward_n), np.asarray(done_n), np.asarray(info_n)
    ...
    def get_adjacency(self):
        return self.world.adjacency_matrix

    def get_has_and_need(self):
        has = []
        need = []
        for agent in self.world.agents:
            has.append(agent.n_has)
            need.append(agent.n_need)

        return has, need

    def get_global_state(self):
        return self.full_state_callback(self.world)
