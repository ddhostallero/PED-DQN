...
class Agent(object):
    ...
    def train(self, use_rx):
        ...
        # if self.train_cnt % (target_update*10) == 0:
            self.ped_dqn.training_peer_qnet()


        # if self.train_cnt % target_update == 0:
        #     x, y = self.ped_dqn.get_aq_pmq_values([state[0]])
        #     print self.ped_dqn.get_mq_values([state[0]])
        #     print y
        #     x, y = self.ped_dqn.get_aq_tmq_values([state[0]])
        #     print y
